...
app.post("/signup", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, hashedPassword, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.trys.push([2, 4, , 5]);
                return [4 /*yield*/, pool.query("INSERT INTO users (name, email, password) VALUES ($1, $2, $3)", [name, email, hashedPassword])];
            case 3:
                _b.sent();
...
app.post("/login", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, result, user, validPass, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
